...
function CreateTicket() {
    return ( 
        <div className='container'>
              <h1 className='fs-2 mt-5 mb-4'>To create a ticket, select a relevant topic</h1>
            <div className='row px-5 mt-5 mb-5'>
  {/* Column 1 - Account Opening */}
  <div className='col-md-4 px-4 mb-3'>
    <h4 className='mb-3'>
      <i className="fa-solid fa-circle-plus me-2" aria-hidden="true"></i>
      Account Opening
    </h4>
  ...
  <div className='col-md-4 px-4'>
    <h4 className='mb-3'>
      <i className="fa-solid fa-chart-column me-2" aria-hidden="true"></i>
      Trading & Platforms
    </h4>
...
<div className='row'>
  ...
  <div className='col-4'>
    <h4 className='mb-3'>
      <i className="fa-regular fa-circle-play me-2"></i>Console
    </h4>
  ...
  <div className='col-4'>
    <h4 className='mb-3'>
      <i className="fa-regular fa-circle-play me-2"></i>Coin
    </h4>
